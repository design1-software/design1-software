...
This teaches thinking, not memorization.
...
Intermediate students may perform approved controlled remediation.
Senior students may design changes and lead advanced simulated incidents.
High-impact changes require instructor approval.
Protected assets remain protected.
```

## What Shift Mode Teaches
...
This document uses fictional examples and avoids private operational details. It does not include real ticket data, internal hostnames, internal addresses, private topology, or sensitive configuration.
